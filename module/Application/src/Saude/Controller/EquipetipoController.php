...
class EquipetipoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EquipeTipo")));
    ...
    public function editarAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $xml = $app->salvarEquipeTipo(\Marabaixo\Util::array_to_xml($dados));
    ...
    public function excluirAction() {
        ...
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EquipeTipo")));
