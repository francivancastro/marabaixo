...
class EstabelecimentosaudetipoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        try {
            ...
            $dados["dominio"] = "EstabelecimentoSaudeTipo";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EstabelecimentoSaudeTipo")));
    ...
    public function excluirAction() {
        ...
        $app = $this->getServiceLocator()->get("AplicacaoFachada");
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EstabelecimentoSaudeTipo")));
    ...
    public function importarAction() {
        ...
        try {
            ...
            $arquivo = $request->getFiles("importar_arquivo");
            
            if (!isset($arquivo["size"])) {
                throw new \Exception("Falha ao Executar Operação, Arquivo Inválido para Importação!");
            }
            ...
            $linhas = \Marabaixo\Util::carregaArquivoDados($filename);
            if (!$linhas) {
                throw new \Exception("Falha ao Executar Operação, Arquivo Inválido para Importação!");
            }
            
            $result = $app->importarEstabelecimentoSaudeTipo($linhas);
            
            $erros = $this->showMessages($result);
