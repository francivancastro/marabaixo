...
class SegmentoterritorialController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $dados["dominio"] = "SegmentoTerritorial";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "SegmentoTerritorial")));
    ...
    public function excluirAction() {
        ...
        $app = $this->getServiceLocator()->get("AplicacaoFachada");
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "SegmentoTerritorial")));
