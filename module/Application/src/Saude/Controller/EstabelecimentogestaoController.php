...
class EstabelecimentogestaoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $dados["dominio"] = "EstabelecimentoGestao";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EstabelecimentoGestao" )));
    ...
    public function editarAction() {
        ...
        $form = new \Saude\Form\EstabelecimentoGestaoForm();
    ...
    public function excluirAction() {
        ...
        $app = $this->getServiceLocator()->get("AplicacaoFachada");
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "EstabelecimentoGestao")));
