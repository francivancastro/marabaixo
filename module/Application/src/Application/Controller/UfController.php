...
class UfController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $xml = $app->listarUfPorPagina(\Marabaixo\Util::array_to_xml($dados));
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfoUf(\Marabaixo\Util::array_to_xml(array("id" => $id)));
    ...
    public function editarAction() {
        ...
        $form = new \Application\Form\UfForm();
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $xml = $app->salvarUf(\Marabaixo\Util::array_to_xml($dados));
    ...
    public function excluirAction() {
        ...
        $app = $this->getServiceLocator()->get("AplicacaoFachada");
        $xml = $app->excluirUf(\Marabaixo\Util::array_to_xml(array("id" => $id)));
