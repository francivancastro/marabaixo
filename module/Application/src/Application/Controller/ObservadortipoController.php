...
class ObservadortipoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $xml = $app->listarObservadorTipoPorPagina(\Marabaixo\Util::array_to_xml($dados));
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfoObservadorTipo(\Marabaixo\Util::array_to_xml(array("id" => $id)));
    ...
    public function editarAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $xml = $app->salvarObservadorTipo(\Marabaixo\Util::array_to_xml($dados));
    ...
    public function excluirAction() {
        ...
        $app = $this->getServiceLocator()->get("AplicacaoFachada");
        $xml = $app->excluirObservadorTipo(\Marabaixo\Util::array_to_xml(array("id" => $id)));
