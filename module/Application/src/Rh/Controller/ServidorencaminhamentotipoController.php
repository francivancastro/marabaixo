...
class ServidorencaminhamentotipoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $dados["dominio"] = "ServidorEncaminhamentoTipo";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorEncaminhamentoTipo")));
    ...
    public function excluirAction() {
        ...
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorEncaminhamentoTipo")));
