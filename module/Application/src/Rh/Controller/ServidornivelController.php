...
class ServidornivelController extends \Marabaixo\Controller\AcessoController {
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorNivel")));
    ...
    public function excluirAction() {
        ...
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorNivel")));
