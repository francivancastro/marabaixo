...
class ServidorsituacaoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $dados["dominio"] = "ServidorSituacao";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $xml = $app->getInfo(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorSituacao")));
    ...
    public function excluirAction() {
        ...
        $xml = $app->excluir(\Marabaixo\Util::array_to_xml(array("id" => $id, "dominio" => "ServidorSituacao")));
