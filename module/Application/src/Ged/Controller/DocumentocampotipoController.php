...
class DocumentocampotipoController extends \Marabaixo\Controller\AcessoController {
    ...
    public function indexAction() {
        ...
        $dados["dominio"] = "DocumentoCampoTipo";
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            $result = $app->getInfo(array("id" => $id, "dominio" => "DocumentoCampoTipo"));
    ...
    public function excluirAction() {
        ...
        $result = $app->excluir(array("id" => $id, "dominio" => "DocumentoCampoTipo"));
