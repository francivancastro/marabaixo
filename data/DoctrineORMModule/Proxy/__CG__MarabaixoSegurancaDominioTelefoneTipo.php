 ...
 */
class TelefoneTipo extends \Marabaixo\Seguranca\Dominio\TelefoneTipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\TelefoneTipo' . "\0" . 'idTelefoneTipo', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\TelefoneTipo' . "\0" . 'chave', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\TelefoneTipo' . "\0" . 'descricao', 'eventos', 'sm', 'em'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TelefoneTipo $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getIdTelefoneTipo()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTelefoneTipo();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTelefoneTipo', []);

        return parent::getIdTelefoneTipo();
    }
     ...
     * {@inheritDoc}
     */
    public function setIdTelefoneTipo($idTelefoneTipo)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdTelefoneTipo', [$idTelefoneTipo]);

        return parent::setIdTelefoneTipo($idTelefoneTipo);
    }
