 ...
 */
class Nacionalidade extends \Marabaixo\Seguranca\Dominio\Nacionalidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Nacionalidade' . "\0" . 'idNacionalidade', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Nacionalidade' . "\0" . 'chave', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Nacionalidade' . "\0" . 'descricao', 'eventos', 'sm', 'em'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nacionalidade $proxy) {
    ...
    public function getIdNacionalidade()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdNacionalidade();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdNacionalidade', []);

        return parent::getIdNacionalidade();
    }
    ...
    public function setIdNacionalidade($idNacionalidade)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdNacionalidade', [$idNacionalidade]);

        return parent::setIdNacionalidade($idNacionalidade);
    }
    ...
    public function getPorChave($chave)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPorChave', [$chave]);

        return parent::getPorChave($chave);
    }
    ...
    public function carregar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'carregar', []);
