 ...
 */
class Municipio extends \Marabaixo\Seguranca\Dominio\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Municipio' . "\0" . 'idMunicipio', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Municipio' . "\0" . 'descricao', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Municipio' . "\0" . 'ibge', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Municipio' . "\0" . 'uf', 'eventos', 'sm', 'em'];
        }
    ...
    public function getIdMunicipio()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdMunicipio();
        }
     ...
     * {@inheritDoc}
     */
    public function setUf(\Marabaixo\Seguranca\Dominio\Uf $uf)
    {
