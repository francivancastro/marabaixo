 ...
 */
class Pais extends \Marabaixo\Seguranca\Dominio\Pais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Pais' . "\0" . 'idPais', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Pais' . "\0" . 'codigo', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Pais' . "\0" . 'descricao', 'eventos', 'sm', 'em'];
        }
    ...
    public function brasil()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'brasil', []);

        return parent::brasil();
    }
