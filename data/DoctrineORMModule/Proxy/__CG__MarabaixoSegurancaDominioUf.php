 ...
 */
class Uf extends \Marabaixo\Seguranca\Dominio\Uf implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Uf' . "\0" . 'idUf', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Uf' . "\0" . 'codigo', '' . "\0" . 'Marabaixo\\Seguranca\\Dominio\\Uf' . "\0" . 'descricao', 'eventos', 'sm', 'em'];
        }
    ...
    public function getIdUf()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdUf();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdUf', []);

        return parent::getIdUf();
    }
    ...
    public function setIdUf($idUf)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdUf', [$idUf]);

        return parent::setIdUf($idUf);
    }
     ...
     * {@inheritDoc}
     */
    public function carregarDefault()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'carregarDefault', []);

        return parent::carregarDefault();
    }
